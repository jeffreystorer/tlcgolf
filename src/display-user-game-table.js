...
function DisplayUserGameTable () {
  ...
  //if ((!localStorage.getItem('lsGames') === null) & (!localStorage.getItem("lsPlayers") === null)) {
  let games = JSON.parse(localStorage.getItem('lsGames'));
  //const players = JSON.parse(localStorage.getItem('lsPlayers'));
  //alert(players);
