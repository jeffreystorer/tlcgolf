...
import { get, set, remove } from "../functions/localStorage"
...
function LoginPage() {
  ...
  let oldGHINNumber, ghinNumber, lastName, showTips, showLocalNumbers
  oldGHINNumber = get("ghinNumber") ? get("ghinNumber") : "GHIN Number"
  ghinNumber = oldGHINNumber
  ...
  function handleClick(e) {
    ...
    if (ghinNumber !== oldGHINNumber) {
      ...
      localStorageKeys.forEach(resetItem)
