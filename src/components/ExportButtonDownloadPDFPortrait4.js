...
const ExportButtonDownLoadPDFPortrait4 = ({ dimensions, title }) => {
  ...
  function createPDF() {
    domtoimage
      .toJpeg(document.getElementById("div_collage-portrait4"), {
        quality: 1.0,
      })
...
export default ExportButtonDownLoadPDFPortrait4
